...
public class CustomItemReaderKillChainPhases implements ItemReader<org.json.JSONObject> {

  List<org.json.JSONObject> items = new ArrayList<>();

  public CustomItemReaderKillChainPhases(JSONArray objects) {
    for (int i = 0; i < objects.length(); i++) {
      org.json.JSONObject object = objects.getJSONObject(i);
      if (object.getString("type").equals("x-mitre-tactic")) {

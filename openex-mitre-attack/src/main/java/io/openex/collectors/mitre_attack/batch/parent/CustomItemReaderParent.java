...
public class CustomItemReaderParent implements ItemReader<org.json.JSONObject> {

  List<org.json.JSONObject> items = new ArrayList<>();

  public CustomItemReaderParent(JSONArray objects) {
    for (int i = 0; i < objects.length(); i++) {
      org.json.JSONObject object = objects.getJSONObject(i);
      if (object.getString("type").equals("relationship") && object.getString("relationship_type").equals("subtechnique-of")) {
